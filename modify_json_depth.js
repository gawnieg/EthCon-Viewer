...
function find_add_remove_nums(opcode){
  ...
  switch(opcode) {
    ...
    break
    case "GASPRICE":
    var r= {c: 0, p:1,colour:97}
    break
    case "EXTCODESIZE":
    var r= {c: 1, p:1,colour:97}
    break
    case "EXTCODECOPY":
    var r= {c: 4, p:0,colour:97}
    break
    case "BLOCKHASH":
    var r= {c: 1, p:1,colour:97}
    break
    ...
    break
    case "LOG3":
    var r= {c: 5, p:0,colour:97}
    break
    case "LOG4":
    var r= {c: 6, p:0,colour:97}
    break
    case "CREATE":
    var r= {c: 3, p:1,colour:145} // bright yellow
    break
    case "CALL":
    var r= {c: 7, p:1,colour:145} //hot pink
    break
    case "CALLCODE":
    var r= {c: 7, p:1,colour:145}
    break
    case "RETURN":
    var r= {c: 2, p:0,colour:97}
    break
    case "DELEGATECALL":
    var r= {c: 6, p:1,colour:97}
    break
    case "SUICIDE":
    var r= {c: 1, p:0,colour:97}
    break
