...
module.exports={
 ...
 save_trans_to_db: function(_trans_no,_graph,_graphml,_sigmaobj,_res_str_dot_no_lbl,graphtools_label,graphtools_color,num_return,_graph_depth){
   console.log("module exports: save_trans_to_db called")
  save_trans_to_db(_trans_no,_graph,_graphml,_sigmaobj,_res_str_dot_no_lbl,graphtools_label,graphtools_color,num_return,_graph_depth);
  }
}
...
mp.MongoClient.connect("mongodb://127.0.0.1:27017/trans")
    .then(function(db){
        return db.collection('test')
            .then(function(col) {
                return col.insert({transaction_no: _trans_no,graph : _graph,graphml:_graphml, sigmaobj:_sigmaobj, simpledot:_res_str_dot_no_lbl,gtlabel: graphtools_label,gtcolor: graphtools_color, blockDepth: num_return,depthLevel:_graph_depth}) //simple dot saved for graph-tools comptability
                    .then(function(result) {
                        //console.log(result);
